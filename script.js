...
function navbarAnimation(){
    gsap.to("#nav-left svg",{
        ...
        scrollTrigger:{
            ...
            // speed of animation + also on returning to top it changes again
            scrub:true
        }
    })
...
//on load page change the course animation
...
// same code but for specific part only
...
//cursor pitch color animation
function cursorAnimationDarkCirlcle(){
    ...
    let cursorChild=document.querySelectorAll(".child");
    cursorChild.forEach(child=>{
